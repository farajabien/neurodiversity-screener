...
export default function ADHDResultsPage() {
  ...
  useEffect(() => {
    ...
    let savedData = localStorage.getItem('adhd-questionnaire_results');
    
    // Fallback to old format if new format doesn't exist
    if (!savedData) {
      savedData = localStorage.getItem('adhd-questionnaire-responses');
    }
    ...
    if (savedData) {
      try {
        ...
        // Calculate scores
        const scoreResult = calculateADHDScore(responsesArray);
        ...
        <div className="max-w-4xl mx-auto space-y-8">
          ...
          <div className="max-w-2xl mx-auto space-y-4">
            ...
            <Button 
              asChild 
              size="lg" 
              className="mobile-btn-large bg-orange-600 hover:bg-orange-700 shadow-lg hover:shadow-xl transition-all duration-200"
            >
              <Link href="/adhd/questionnaire">
