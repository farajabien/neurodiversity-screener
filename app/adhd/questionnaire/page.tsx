...
import { adhdQuestions, isPartA } from "@/lib/data/adhd-questions";
import { useEffect } from "react";

export default function ADHDQuestionnairePage() {
  const questionnaire = useQuestionnaire({
    questions: adhdQuestions,
    storageKey: 'adhd-questionnaire',
    resultsPath: '/adhd/results'
  });
  
  const { trackStart } = useQuestionnaireTracking('adhd');
      ...
      <div className="container mx-auto px-4 py-8 sm:py-12 lg:py-16">
        <div className="text-center">
          ...
          <Button asChild className="mt-4">
            <Link href="/adhd">Back to ADHD Screener</Link>
          </Button>
        </div>
      </div>
    );
    ...
    <div className="container mx-auto px-4 py-8 sm:py-12 lg:py-16">
      ...
      <div className="text-center space-y-4 max-w-2xl mx-auto mb-8">
        <div className="flex items-center justify-center gap-3">
          ...
          <h1 className="text-2xl font-bold">ADHD Screener</h1>
        </div>
      ...
      <QuestionCard
        ...
        totalQuestions={questionnaire.totalQuestions}
        part={isPartA(questionnaire.currentQuestionIndex) ? 'A' : 'B'}
      />
      ...
      <Card className="max-w-2xl mx-auto mt-8 bg-muted/30">
        <CardContent className="pt-6">
          <div className="text-center space-y-2">
            ...
            {isPartA(questionnaire.currentQuestionIndex) && (
              <p className="text-xs text-orange-600 dark:text-orange-400 font-medium">
                Part A: Most predictive questions for ADHD screening
              </p>
            )}
          </div>
        </CardContent>
